...
@Component({
  ...
  styleUrls: ['./sierra-inputs.component.scss'],
  templateUrl: './sierra-inputs.component.html',
})
export class SierraInputsComponent {
  ...
  onSubmit() {
     this.submitted = true;  
     let myHero =  new Sierra("","","",1234567890,"",this.numofdays,this.tleclass,"","","","",12345567788);
